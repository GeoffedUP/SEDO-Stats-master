...
const _CONTRACT_ADDRESS = "0x0F00f1696218EaeFa2D2330Df3D6D1f94813b38f";
...
var known_miners = {
  "0x790AAC02412E8665604bdaE39B00BE012F4acc12" : [ "Sedo Official Mining Pool", "http://95.169.186.41",     pool_colors.orange ],
  "0xae212C80809ADcE867C195108edB6df0E2006e54" : [ "Sedo Official Mining Pool", "http://95.169.186.41",     pool_colors.orange ], // mint helper contract (old)
}
...
var eth = new Eth(new Eth.HttpProvider("https://mainnet.infura.io/f12d6274997840158b99b418f0ed8ec1"));
...
stats = [
  ...
  ['Tokens Minted',                 token.tokensMinted,                   "SEDO",      0.00000001, null     ], /* supply */
  ['Max Supply for Current Era',    token.maxSupplyForEra,                "SEDO",      0.00000001, null     ], /* mining */
  ['Supply Remaining in Era',       null,                                 "SEDO",      0.00000001, null     ], /* mining */
  ...
  ['Current Mining Reward',         token.getMiningReward,                "SEDO",      0.00000001, null     ], /* mining */
  ['Epoch Count',                   token.epochCount,                     "",           1,          null     ], /* mining */
  ['Total Supply',                  token.totalSupply,                    "SEDO",      0.00000001, null     ], /* supply */
  ['',                              null,                                 "",           1,          null     ], /* */
...
function updateStatsThatHaveDependencies(stats) {
  ...
  el_safe('#SupplyRemaininginEra').innerHTML = "<b>" + supply_remaining_in_era.toLocaleString() + "</b> SEDO <span style='font-size:0.8em;'>(" + rewards_blocks_remaining_in_era + " blocks)</span>";
